...
class Opening(tkinter.Tk):
    ...
    def addButton(self, s, text, command, width=12, side=TOP, font=("Times", 15)):
    ...
    def main(self):
        ...
        self.addButtonPlace(self.chooseF, "Choose a file", command=self.OpenFile)
        self.addButtonPlace(self.chooseF, "Quit", command=self.quitter, rely=0.8)
